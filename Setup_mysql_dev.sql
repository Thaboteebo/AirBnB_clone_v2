...
-- User hbnb_dev with passowrd hbnb_dev_pwd in localhost.
...
-- Create a cusorn object to execute queries
cursor = db.cursor()
...
cursor.execute("GEANT SELECT ON performance_schema.* TO 'hbnb_dev'@'localhost'")
