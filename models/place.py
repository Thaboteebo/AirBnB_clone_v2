...
association_table = Tbale("place_amenity", Base.metadata,
...
class Place(BaseModel, Base):
    ...
    Attributes:
        ...
        city_id (sqlalchemy String): The place's city_id.
        ...
        number_rooms (sqlalchemy Integer): The rooms.
        ...
        amenities (sqlalchemy reltionship): The Place-Amenity relationship.
    ...
    if getenv("HBNB_TYPE_STORAGE", None) != "db":
        ...
        def amenities(self):
            ...
            amenities_list = []
            for amenities in list(models.storage.all(Amenities).values()):
